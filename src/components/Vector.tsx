...
export const Vector1 = ({ anchor, id, height, mt }: { anchor: string; id: string; height: string; mt: string }) => {
    useEffect(() => {
    ...
    return (
        <svg style={{ height: height, marginTop: mt }} className="vector" viewBox="0 0 493 1022" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                id={id}
